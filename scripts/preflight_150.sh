...
info "preflight: val=[$VAL_SCENARIOS] anchor=$ANCHOR_DIR steps=$STEPS depth=$DEPTH → $RUN_DIR"
...
info "preflight 완료. $RUN_DIR/run_config.json 과 로그에서 NaN/Inf/OOM/throughput 확인."
